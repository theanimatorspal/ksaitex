...
% \MAGIC{ page_break, label='नयाँ पृष्ठ', command='\pagebreak' }
% \MAGIC{ devanagari_num, label='देवनागरी अंक', command='\renewcommand{\thepage}{\devanagaridigits{\value{page}}}' }
% \MAGIC{ devanagari_alph, label='देवनागरी अक्षर', command='\renewcommand{\thepage}{\devanagarialph{\value{page}}}' }
% \MAGIC{ horizontal_rule, label='तेर्सो रेखा', command='\hrule' }
