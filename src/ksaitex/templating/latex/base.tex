...
% \MAGIC{ table_align, label='table_align', tab='ढाँचा', args='align:select,Left,Right:Left', command='\settablealign{VAR_align}' }
...
% \MAGIC{ vyanucched_begin, label='व्यनुच्छेद सुरु', tab='ढाँचा', pairing='begin', group='vyanucched', args='align:select,left,center,right:right|inner_align:select,left,center,right:center|width:number:1', command='\begin{vyanucched}{VAR_align}{VAR_inner_align}{VAR_width}' }
% \MAGIC{ vyanucched_end, label='व्यनुच्छेद अन्त्य', tab='ढाँचा', pairing='end', group='vyanucched', command='\end{vyanucched}' }

% \MAGIC{ itishree_begin, label='इतिश्री सुरु', tab='ढाँचा', pairing='begin', group='itishree', args='align:select,alternating,left,right,center:center|ornament:select,88,87,84,75,71,63,1:84', command='\begin{itishree}[VAR_align]{VAR_ornament}' }
% \MAGIC{ itishree_end, label='इतिश्री अन्त्य', tab='ढाँचा', pairing='end', group='itishree', command='\end{itishree}' }
...
\newenvironment{itishree}[2][center]%
  {\begin{visheshshlokatwo}[#1]{#2}}%
...
% }{%
%             \end{shloka}%
%         \end{varwidth} & \small\visheshauthor
%     \end{tabular}%
%     \end{center}%
% }
...
\newenvironment{visheshshlokathree}[2][alternating]{%
    ...
    \hfill\hfill\hfill\quad\small\visheshauthor\hfill
    \end{shloka}%
}

\newenvironment{vyanucched}[3]{% #1 = outer align, #2 = inner align, #3 = width multiplier
  \par
