...
% \MAGIC{ section, label='खण्ड (Sec)', tab='ढाँचा', args='title:text:नयाँ खण्ड', command='\section{VAR_title}' }
% \MAGIC{ subsection, label='उपखण्ड (Subssec)', tab='ढाँचा', args='title:text:नयाँ उपखण्ड', command='\subsection{VAR_title}' }
...
% \MAGIC{ empty_page, label='खाली पृष्ठ (Empty Page)', tab='लेआउट', command='\thispagestyle{empty}' }
% \MAGIC{ set_page_counter, label='पृष्ठ संख्या सेट गर्नुहोस्', tab='पृष्ठ संख्या', args='num:number:1', command='\setcounter{page}{VAR_num}' }
